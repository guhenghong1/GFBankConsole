	...
	<div class="warrant" style="padding: 20px">
		<div id="tb" style="height: auto" menu="${menu}">
			<div class="updateUpdate">	
				...
				<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-help',plain:true" style="" onclick="WarrantU.deleteOp()">删除</a>
			</div>
		</div>
        <div class="queryWarrant_u">
	        <table>
	        	<tr>
	           ...
	           <td>
	            ...
	            <td><a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="queryWarrant_U()">查询</a></td>
	            <td><a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="clearQuery_U()">重置</a></td>
	            </tr>
	            </table>
            </div>
		<table id="warrant_u" rownumbers="true"></table>
		
		<div id="warw_u" class="easyui-window" title=""
			data-options="modal:true,closed:true,iconCls:'icon-save'"
			style="width: 500px; height: 400px; padding: 10px;">
		<form id="warrantForm_u" method="post" action="${basePath}/warrant/addWarrant.do" enctype="multipart/form-data">  
			<table>
	<!-- 			<tr>
			...
			<div style="margin: 20px 0;">
				...
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="$('#warw_u').window('close')">取消</a>
			</div>
		</form>
		</div>
		
		<div id="mwarw_u" class="easyui-window" title="修改权证"
			data-options="modal:true,closed:true,iconCls:'icon-save'"
			style="width: 500px; height: 400px; padding: 10px;">
		<form id="mwarrantForm_u" method="post" action="${basePath}/warrant/updateWarrant.do" enctype="multipart/form-data">  
			<table>
				...
				<tr>
					<td><label>备注信息：<font style="color: red">*</font></label></td>
					<td><input  name= "remarkName" class="mremarkName" type="text" value="" style="display:none"></input>
				...
				<tr>
					...
					<td><select  name="status" class="easyui-combobox mstatus" panelHeight="auto" data-options="readonly:true, disabled:true" style="width:160px">  
			                <option value="0">待入库</option>  
			                <option value="1">已入库</option>  
			                <option value="2">出库</option>  
			            </select>  
			...
			<div class="operate" style="margin: 20px 0;">
				...
				<a href="javascript:void(0)" class="easyui-linkbutton update" style="" onclick="updateWarrant_U()">保存</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="$('#mwarw_u').window('close')">取消</a>
			</div>
		</form>
		</div>
