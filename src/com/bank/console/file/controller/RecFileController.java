...
public class RecFileController {
	...
	@ResponseBody
	public String getFileList(@ModelAttribute("qrecFileForm") RecFileForm form) {
		int total = recFileService.getFileSum(form);
	...
	public String getFileList(@RequestParam("fileId") String fileId) {
		ResultUtil result = new ResultUtil();
		RecFile recFile = recFileService.getFileInfo(fileId);
...
//	public @ResponseBody List<String> findAttachments(@RequestParam String busiGlobalSeq) {
//		List<String> attachments = fileService.findAttachments(busiGlobalSeq);
//		return attachments;
//	}
	...
	public String findFile(@RequestParam("fileId") String fileId) {
		RecFile file = recFileService.getFileInfo(fileId);
